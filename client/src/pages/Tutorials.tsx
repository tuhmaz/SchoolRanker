...
const videos = [
  ...
  {
    title: "التجهيزات الأساسية 2",
    description: "شرح مفصل لرفع ومعالجة ملف منصة أجيال - النموذج الثاني (EL_StudentInfoReport) مع توضيح الفروقات عن النموذج الأول وطريقة استخدام التبويب الأحمر في صفحة التجهيزات الموحدة.",
    filename: "التجهيزات الأساسية 2.mp4",
    duration: "12:15",
  },
  {
